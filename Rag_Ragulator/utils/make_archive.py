...
top_dir = '/Users/iecheverria/Dropbox/UCSF/yeast_npc/repo/'
ARCHIVES = {
  os.path.join(top_dir,'data'): 'data',
  os.path.join(top_dir,'integrative_threading/scripts'): 'scripts',
  os.path.join(top_dir,'integrative_threading/results'): 'models'}
